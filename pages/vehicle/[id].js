        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "offers": {
              ...
              "seller": { "@type": "AutoDealer", "name": vehicle.dealer_name }
            }
          })
        }} />
      </Head>
            ...
            <div className="p-4 rounded-2xl border-2" style={{ borderColor: '#0055A4', background: '#f0f7ff' }}>
              <div className="flex items-start justify-between">
                ...
                <div className="text-right">
                  ...
                  <span className={`inline-block mt-1 px-2 py-1 rounded-full text-xs font-semibold ${tierColors[vehicle.score_tier] || tierColors.Unrated}`}>
                    {vehicle.score_tier}
                  </span>
            ...
            <div className="space-y-3">
              ...
              {vehicle.dealer_phone && (
                <a href={`tel:${vehicle.dealer_phone}`}
                  className="block w-full py-4 rounded-xl font-bold text-base text-center border-2"
