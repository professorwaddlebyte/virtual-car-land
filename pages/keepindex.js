                ...
                >
                  <div className="flex flex-col sm:flex-row gap-2">
                    ...
                    <button
                      ...
                      // Added flex-shrink-0 to prevent layout squeezing
                      className="flex items-center justify-center gap-2 px-8 py-4 rounded-[20px] text-white font-black text-sm uppercase tracking-wider transition-all hover:brightness-110 active:scale-95 shadow-lg disabled:opacity-60 disabled:cursor-not-allowed whitespace-nowrap flex-shrink-0"
                      style={{
                        background: aiLoading ? "#0d6b5e" : "#FFD700",
                        color: aiLoading ? "white" : "#1a1a1a",
                        minWidth: "fit-content", // Force browser to respect the text width
                      }}
                    >
                      {aiLoading ? (
                        <>
                ...
                <div className="flex items-center justify-center gap-4">
                  {[
                    ...
                    <div
                      ...
                      style={{
                        background:
                          i === 0 ? "#FFD93D" : i === 1 ? "#FFE066" : "#FFF0A0",
                        borderRadius: "4px 4px 4px 4px",
                        boxShadow:
                          "3px 4px 12px rgba(0,0,0,0.18), inset 0 -3px 0 rgba(0,0,0,0.08)",
