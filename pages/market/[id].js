...
export default function MarketPage() {
  ...
  // makes and colors can arrive as string or array from Next.js router
  ...
  // AI search badge — shown when the user arrived via AI search
  ...
  useEffect(() => {
    ...
    const hasAiParams = qMakes.length > 0 || qColors.length > 0 || qMileageMax || qTrans || qBody;
    ...
    fetchMarket();
    fetchVehicles(initialFilters, 1, qMakes, qColors);
  ...
  // makesArr and colorsArr are optional overrides (used on first load from URL)
  async function fetchVehicles(activeFilters, page = 1, makesArr = [], colorsArr = []) {
    setLoading(true);
    ...
    // makes array — prefer passed-in array, otherwise use single make filter
  ...
  // Human-readable summary of AI-applied filters for the badge
    ...
    <>
      ...
      <div className="min-h-screen bg-[#F8FAFC] flex flex-col font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8 flex-1 w-full">
          ...
          {aiSearchActive && (
            <div
              className="mb-6 flex items-center justify-between gap-4 px-6 py-4 rounded-[20px] border"
